...
public class AdminServiceImpl implements AdminService {
	...
	private User saveUserInternal(User user) {
		if (!Utils.checkEmailWithRegExp(user.getEmail()) || user.getPassword() == null || (!Utils.checkPasswordWithRegExp(user.getPassword()) & user.getId() == null)) {
	...
	private Company saveCompanyInternal(Company company) {
		if (!Utils.checkEmailWithRegExp(company.getEmail()) || (!Utils.checkPhoneNumberWithRegExp(company.getPhone()))) {
